...
export class CloseLeadRequestDto {
    ...
    @ApiPropertyOptional({ type: [TeamAssignmentRequestDto], description: 'Danh sách nhân viên phụ trách' })
    @IsOptional()
    @IsArray()
    @ValidateNested({ each: true })
    @Type(() => TeamAssignmentRequestDto)
