...
const authentication_service_1 = require("./application/services/authentication.service");
...
exports.AuthModule = AuthModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [authentication_service_1.AuthenticationService, jwt_strategy_1.JwtStrategy, jwt_auth_guard_1.JwtAuthGuard],
        exports: [jwt_auth_guard_1.JwtAuthGuard, authentication_service_1.AuthenticationService, jwt_1.JwtModule, passport_1.PassportModule],
    })
], AuthModule);
