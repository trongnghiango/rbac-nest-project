...
## File: src/core/constants/pg-error-codes.ts
```
...
## File: src/modules/user/domain/services/user-uniqueness.checker.ts
```
import { Injectable, Inject } from '@nestjs/common';
...
## File: src/modules/user/domain/exceptions/user-domain.exceptions.ts
```
...
## File: src/modules/user/domain/types/user-contexts.type.ts
```
...
export class RoleService {
  ...
  async createRole(data: CreateRoleParams): Promise<Role> {
    ...
    // ✅ Không còn positional arguments
    const role = new Role({
      name: data.name,
